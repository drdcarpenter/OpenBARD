...
The OpenBARD package provides the data in a convenient format for R users.
...
If you encounter a bug, please file an issue with a minimal reproducible example on [Codeberg](https://codeberg.org/drdcarpenter/OpenBARD/issues).
